{
  ...
  # Ironbar is the bar of the hand-assembled "custom" shell. Wayle,
  # noctalia, and dms bring their own bars; keeping ironbar active
  # alongside them would duplicate layer-shell surfaces and tray ownership.
