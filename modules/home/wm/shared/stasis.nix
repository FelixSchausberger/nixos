...
in {
  config = lib.mkIf (shouldEnable && shellKeepsStasis) {
    ...
    # Stasis rewrites this file at runtime ("auto-generated by Stasis on
    # first run"), replacing the symlink with a regular file. Force overwrite
    # so standalone activations (just niri-reload) don't fail in
    # checkLinkTargets; the nix config is the source of truth.
