...
# Common environment variables for all Wayland compositors
{
  ...
  xdg.portal = {
    ...
    config = lib.mkMerge [
      ...
      (lib.mkIf (builtins.elem "hyprland" hostConfig.wm && config.programs.hyprland.enable) {
      ...
      (lib.mkIf (builtins.elem "niri" hostConfig.wm && config.programs.niri.enable && !config.programs.hyprland.enable) {
      ...
      (lib.mkIf (builtins.elem "gnome" hostConfig.wm && !config.programs.hyprland.enable && !config.programs.niri.enable) {
