...
Architectural decisions, design rationale, module patterns, and "why" choices belong
as inline comments in the file where they are implemented — not in separate .md files.

**Do not create:**

- ARCHITECTURE.md or similar design overview files
- Per-subsystem .md files explaining how modules work
- docs/ directories for generated or autogenerated metrics

**Use inline comments instead:**

- Add a file-level comment when the file's purpose or constraints are non-obvious
- Explain guard patterns, evaluation trade-offs, and design choices at the site where
  they appear
- Keep comments state-focused and concise (see Inline Comments section)

**Exceptions (legitimate .md files):**

- README.md — project entry point and quick-reference for developers
- CLAUDE.md — AI workflow and development guidelines
- tools/CLAUDE.md — additions and conventions for creating new tools and packages
- hosts/installer/README.md — operational installation procedure
...
the daily lock-update workflow consistent.
...
For complete CI/CD details, see
[README.md Build and Deploy](README.md#build-and-deploy) → CI/CD Pipeline
section:
...
This system uses modern CLI replacements for standard Unix tools. Claude
Code's built-in tools already leverage these where appropriate.
...
[README.md Additional Documentation](README.md#additional-documentation) →
Wiki: Secret Management.
